    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns" v-if="fees > 0">
          ...
          <div class="column info-value monospace">{{ fees | btcbam }} BTCBAM</div>
        </div>
        ...
        <Transaction
          :transaction="{
            ...
            contractSpends,
            brc20TokenTransfers, brc721TokenTransfers
          }"
          detailed
  ...
  export default {
    ...
    async asyncData({req, params, error}) {
      try {
        ...
        return {
          ...
          brc20TokenTransfers: transaction.brc20TokenTransfers,
          brc721TokenTransfers: transaction.brc721TokenTransfers
        }
      } catch (err) {
    ...
    methods: {
      refresh(transaction) {
        ...
        this.brc20TokenTransfers = transaction.brc20TokenTransfers
        this.brc721TokenTransfers = transaction.brc721TokenTransfers
      },
      splitData(data) {
