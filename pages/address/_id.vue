<template>
  <section class="container">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            {{ balance | btcbam }} BTCBAM
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | btcbam }} BTCBAM {{ $t('address.unconfirmed') }},
              {{ staking | btcbam }} BTCBAM {{ $t('address.staking') }})
            </span>
    ...
    <nuxt-child :tokens="brc20Balances.map(({address, name, symbol}) => ({address, name, symbol}))" />
  </section>
</template>
